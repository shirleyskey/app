<?php 
	...
	<?php } else{
		$themsv = "INSERT INTO `tai_khoan` (`id_tai_khoan`, `ten_tai_khoan`, `mat_khau`, `nhom_tai_khoan`, `ten_sinh_vien`, `sdt`, `ngay_sinh`, `ngay_tao`) VALUES (NULL, '$tenadmin', '$matkhau', '1', '$tenadminht', '$sdt', '$ngaysinh', NOW())";
