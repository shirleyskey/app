<?php 
	...
	if($tenadmin == NULL || $tenadminht == NULL || $sdt == NULL || $ngaysinh == NULL){ ?>
	...
	<?php } else{
		$themsv = "INSERT INTO `tai_khoan` (`id_tai_khoan`, `ten_tai_khoan`, `mat_khau`, `nhom_tai_khoan`, `ten_sinh_vien`, `sdt`, `ngay_sinh`, `ngay_tao`) VALUES (NULL, '$tenadmin', '$matkhau', '0', '$tenadminht', '$sdt', '$ngaysinh', NOW())";
		mysqli_query($conn, $themsv); ?>
			...
			<script>
			window.setTimeout(function(){window.location.href="./index.php?menu=giaovien";}, 100);
		</script> 
		<?php } ?>
